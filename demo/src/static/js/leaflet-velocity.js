...
L.Control.Velocity = L.Control.extend({
	...
	onAdd: function onAdd(map) {
		...
		//this._container=document.getElementById("UVpopu")
...
/***************鼠标移动显示流速和流向*************************/
	_onMouseMove: function _onMouseMove(e) {
		...
		if (gridValue && !isNaN(gridValue[0]) && !isNaN(gridValue[1]) && gridValue[2]) {
			var angle =self.vectorToDegrees(gridValue[0], gridValue[1], this.options.angleConvention).toFixed(2);		
			htmlOut ="<strong>流向：</strong>"+angle + "°, <strong>" + " 流速: </strong>" + self.vectorToSpeed(gridValue[0], gridValue[1], this.options.speedUnit).toFixed(2) + this.options.speedUnit;
		    $('#UVpopu').show().css({
...
var Windy = function Windy(params) {
	...
	var PARTICLE_LINE_WIDTH = params.lineWidth || 1; // line width of a drawn particle线宽
	var PARTICLE_MULTIPLIER = params.particleMultiplier || 1 / 10; // particle count scalar (completely arbitrary--this values looks nice)密度
	var PARTICLE_REDUCTION = Math.pow(window.devicePixelRatio, 1 / 3) || 1.6; // multiply particle count for mobiles by this amount
	var FRAME_RATE = params.frameRate || 15,
	    FRAME_TIME = 1000 / FRAME_RATE; // desired frames per second

//  	var defaulColorScale = ["rgb(0,0,255)", "rgb(65,105,225)", "rgb(0,191,255)", "rgb(0,255,255)", "rgb(64,224,208)", "rgb(	0,255,127)", "rgb(0,255,0)", "rgb(127,255,0)", 
//  	"rgb(127,255,0)", "rgb(173,255,47)", "rgb(255,255,0)", "rgb(255,215,0)", "rgb(255,165,0)", "rgb(244,164,96)",  "rgb(255,127,80)",  "rgb(255,69,0)",  "rgb(255,0,0)"];
//   
   var defaulColorScale = ["#1567af"];
